...
class FixedAnswerLogicAdapter(LogicAdapter):
    def __init__(self, bot, **kwargs):
        ...
        self.fixed_responses = {
            'find me cafés in amsterdam': 'I found some information about the cafés in Amsterdam. \n <img src="https://github.com/AlessiaWang/myimage/blob/main/stimuli.png?raw=true" height="500">',
            'find me café in amsterdam': 'I found some information about the cafés in Amsterdam. \n <img src="https://github.com/AlessiaWang/myimage/blob/main/stimuli.png?raw=true" height="500">',
            'find me cafes in amsterdam': 'I found some information about the cafés in Amsterdam. \n <img src="https://github.com/AlessiaWang/myimage/blob/main/stimuli.png?raw=true" height="500">',
            'find me cafe in amsterdam': 'I found some information about the cafés in Amsterdam. \n <img src="https://github.com/AlessiaWang/myimage/blob/main/stimuli.png?raw=true" height="500">',
