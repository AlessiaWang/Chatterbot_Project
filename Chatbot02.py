...
class FixedAnswerLogicAdapter(LogicAdapter):
    def __init__(self, bot, **kwargs):
        ...
        self.fixed_responses = {
            'find me cafés in amsterdam': 'I’d love to recommend you to try the following cafés in Amsterdam. \n <img src="https://github.com/AlessiaWang/myimage/blob/main/stimuli.png?raw=true" height="500">',
            'find me café in amsterdam': 'I’d love to recommend you to try the following cafés in Amsterdam. \n <img src="https://github.com/AlessiaWang/myimage/blob/main/stimuli.png?raw=true" height="500">',
            'find me cafes in amsterdam': 'I’d love to recommend you to try the following cafés in Amsterdam. \n <img src="https://github.com/AlessiaWang/myimage/blob/main/stimuli.png?raw=true" height="500">',
            'find me cafe in amsterdam': 'I’d love to recommend you to try the following cafés in Amsterdam. \n <img src="https://github.com/AlessiaWang/myimage/blob/main/stimuli.png?raw=true" height="500">',
...
bot = ChatBot('Alex02',
    ...
    database_uri='sqlite:///database2.db',logic_adapters=[
        {
...
trainer.train(['find me café in amsterdam', 'I’d love to recommend you to try the following cafés in Amsterdam. \n <img src="https://github.com/AlessiaWang/myimage/blob/main/stimuli.png?raw=true" height="500">'])
trainer.train(['find me cafes in amsterdam', 'I’d love to recommend you to try the following cafés in Amsterdam. \n <img src="https://github.com/AlessiaWang/myimage/blob/main/stimuli.png?raw=true" height="500">'])
...
trainer.train(['find café in amsterdam', 'I’d love to recommend you to try the following cafés in Amsterdam. \n <img src="https://github.com/AlessiaWang/myimage/blob/main/stimuli.png?raw=true" height="500">'])
trainer.train(['find cafes in amsterdam', 'I’d love to recommend you to try the following cafés in Amsterdam. \n <img src="https://github.com/AlessiaWang/myimage/blob/main/stimuli.png?raw=true" height="500">'])
